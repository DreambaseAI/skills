...
| Datasets         | `list_datasets`, `get_dataset`, `query_dataset`, `plan_datasets`, `save_dataset`, `promote_dataset`, `manage_dataset_schedule` |
...
OAuth scopes _and_ your workspace membership: the tool list you see is exactly
...
- **Descriptions** state what the skill does _and_ when to trigger it (be
